      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-warm-white/70 font-body text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-8">
              If this resonates, the next step is a simple conversation.
            </p>
            <div className="flex flex-col items-center gap-2 text-warm-white/60 font-body">
